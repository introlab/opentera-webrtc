...
namespace introlab
{
    class StreamPeerConnectionHandler : public PeerConnectionHandler
    {
        ...
        std::shared_ptr<rtc::VideoSinkInterface<webrtc::VideoFrame>> m_videoSink;
        rtc::VideoSinkWants m_videoSinkWants;
    ...
    public:
        StreamPeerConnectionHandler(
                ...
                std::shared_ptr<rtc::VideoSinkInterface<webrtc::VideoFrame>>  videoSink = nullptr,
                const rtc::VideoSinkWants& videoSinkWants = rtc::VideoSinkWants(),
