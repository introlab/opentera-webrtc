...
void setOnDataChannelMessageBinary(DataChannelClient& self,
...
void opentera::initDataChannelClientPython(pybind11::module& m)
{
    py::class_<DataChannelClient, SignalingClient>(m, "DataChannelClient",
            ...
            .def(py::init<SignalingServerConfiguration, WebrtcConfiguration, DataChannelConfiguration>(),
                    ...
                    "\n"
                    ":param signaling_server_configuration: The signaling server configuration\n"
            ...
            .def("send_to", [](DataChannelClient& self, const py::bytes& bytes, const vector<string>& ids)
            {
            ...
            .def("send_to", py::overload_cast<const string&, const vector<string>&>(&DataChannelClient::sendTo),
                    "Sends a string message to the specified clients.\n"
                    "\n"
                    ":param message: The string message\n"
                    ":param ids: The client ids",
                    py::arg("message"), py::arg("ids"))
            .def("send_to_all", [](DataChannelClient& self, const py::bytes& bytes)
            {
                auto data = bytes.cast<string>();
