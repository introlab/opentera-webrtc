...
bool RosVideoSource::is_screencast() const
{
    return false;
}

bool RosVideoSource::remote() const
{
    return false;
}

absl::optional<bool> RosVideoSource::needs_denoising() const
{
    return false;
}

webrtc::MediaSourceInterface::SourceState RosVideoSource::state() const
{
